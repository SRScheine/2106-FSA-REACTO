/*
https://gist.github.com/InnovaTori/3a185a6492c89f99dd37949733b6c305
...
Nice other solution:
function includes(input1, input2) {
  for (let i = 0; i < input2.length - input1.length; i++) {
    const subString = input2.slice(i, i + input1.length)
    if (input1 === subString) return i
  }
  return -1
}
*/
